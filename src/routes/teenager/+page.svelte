<script>
  ...
  const slides = [
    { url: 'https://cdn.imweb.me/thumbnail/20230905/fb2602b24c041.jpg', alt: '청소년 심폐소생술 교육 실습 1' },
    { url: 'https://cdn.imweb.me/thumbnail/20230905/0905a15895f73.jpg', alt: '청소년 심폐소생술 교육 실습 2' },
    { url: 'https://cdn.imweb.me/thumbnail/20230905/cf60da9fdfb83.jpg', alt: '청소년 심폐소생술 교육 실습 3' },
    { url: 'https://cdn.imweb.me/thumbnail/20230905/31ef7a07be563.jpg', alt: '청소년 심폐소생술 교육 실습 4' }
  ];
...
<svelte:head>
  <title>청소년 심폐소생술 교육 | 마인드앤매뉴얼</title>
  ...
  <div class="container hero-container-header animate-fade-in">
    <div class="hero-header-row">
      <div class="hero-title-area">
        <h1 class="hero-title">청소년 심폐소생술 교육</h1>
        <p class="hero-subtitle">청소년 심폐소생술은 초/중/고 학생을 대상으로 매년 진행하는 법정의무 교육과정입니다.</p>
      </div>
      <div class="hero-badge-area">
        <div class="circular-badge">초·중·고<br />학생</div>
      ...
      <div class="intro-desc-card">
        <ul class="intro-desc-list">
          <li>
            ...
            『학교보건법』에 의거한 전문 강사 및 프로그램에 따라 가슴압박술과 자동심장충격기 사용법 등 실습 중심의 심폐소생술을 학습할 수 있습니다.
          </li>
          <li>
            <span class="bullet-dot"></span>
            교육은 출장 강의 형태로 진행됩니다.
          ...
          <li class="font-weight-500">
            <span class="bullet-dot"></span>
            청소년 심폐소생술 교육은 관련법령 『학교보건법 제9조의2(보건교육 등)』, 동법시행규칙 『학교보건법 제10조(응급처치교육 등)』의 기준 등을 준수하여 진행됩니다.
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="details-grid animate-slide-up">
      ...
      <div class="split-card">
        ...
        <div class="card-right-block">
          <ul class="body-list">
            <li><span class="bullet-label">대상 :</span> 초·중·고 학생</li>
            <li><span class="bullet-label">교육 비용 :</span> 학급당 150,000원 (VAT 별도)</li>
            <li class="notice-item">* 학급 단위가 아닌 강당 등 집합 교육이 가능할 경우 교육비가 할인됩니다.</li>
          </ul>
        </div>
      </div>
      ...
      <div class="split-card">
        ...
        <div class="card-right-block flex-row-layout">
          ...
          <div class="time-badge">교육 시간 : 총 2교시</div>
        </div>
      </div>
      ...
      <div class="split-card">
        ...
        <div class="card-right-block">
          <ul class="body-list">
            ...
            <li><span class="bullet-label">보조강사 :</span> 교육생 인원에 따라 실습 보조를 위해 추가 배치</li>
          </ul>
        </div>
      </div>
      ...
      <div class="split-card double-layout-card">
        ...
        <div class="card-right-block flex-row no-padding overflow-hidden">
          ...
          <div class="card-img-side">
            <img src="https://cdn.imweb.me/upload/S20230801dc74a8f9b2b46/4ca30be84644e.png" alt="청소년 실습 교구" />
          </div>
        </div>
      </div>
...
<style>
  ...
  .apply-section {
    position: relative;
    padding: 90px 0;
    background-image: linear-gradient(rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0.75)), url('https://cdn.imweb.me/thumbnail/20230908/9849a6a54c9cb.png');
