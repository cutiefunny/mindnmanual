<script>
  ...
  const slides = [
    { url: 'https://cdn.imweb.me/thumbnail/20230905/a9ce09942e9d0.jpg', alt: '교직원 응급처치 교육 실습 1' },
    { url: 'https://cdn.imweb.me/thumbnail/20230905/fe122467bd748.jpg', alt: '교직원 응급처치 교육 실습 2' },
    { url: 'https://cdn.imweb.me/thumbnail/20230905/0c2a7b03ca6aa.jpg', alt: '교직원 응급처치 교육 실습 3' },
    { url: 'https://cdn.imweb.me/thumbnail/20230905/5ad36fcc3c39a.jpg', alt: '교직원 응급처치 교육 실습 4' }
  ];
...
<svelte:head>
  <title>교직원 응급처치 교육 | 마인드앤매뉴얼</title>
  <meta name="description" content="학교보건법 기준에 의거한 초/중/고 교직원 대상 법정의무 응급처치 교육과정. 전문 자격 보유 강사진이 학교로 직접 찾아가 실습 중심으로 진행합니다." />
</svelte:head>
  ...
  <div class="container hero-container-header animate-fade-in">
    <div class="hero-header-row">
      <div class="hero-title-area">
        <h1 class="hero-title">교직원 응급처치 교육</h1>
        <p class="hero-subtitle">교직원 응급처치법은 초/중/고 교직원을 대상으로 매년 진행하는 법정의무 교육과정입니다.</p>
      </div>
      <div class="hero-badge-area">
        <div class="circular-badge">초·중·고<br />교직원</div>
      ...
      <div class="intro-desc-card">
        <ul class="intro-desc-list">
          <li>
            ...
            『학교보건법』에 의거한 전문 강사 및 프로그램에 따라 교내에서 발생할 수 있는 심폐소생술을 비롯한 중요 응급처치법을 실습 중심으로 학습할 수 있습니다.
          </li>
          <li>
            <span class="bullet-dot"></span>
            교육은 출장 강의 형태로 진행됩니다.
          ...
          <li class="font-weight-500">
            <span class="bullet-dot"></span>
            교직원 응급처치 교육은 관련법령 『학교보건법 제9조의2(보건교육 등)』, 동법시행규칙 『학교보건법 제10조(응급처치교육 등)』의 기준 등을 준수하여 진행됩니다.
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="details-grid animate-slide-up">
      ...
      <div class="split-card">
        ...
        <div class="card-right-block">
          <ul class="body-list">
            <li><span class="bullet-label">대상 :</span> 초·중·고 교직원</li>
            <li><span class="bullet-label">교육 비용 :</span> 500,000원 (VAT 별도)</li>
            <li class="notice-item">* 교육 인원 100명 초과 시 추가 계약을 권장합니다.</li>
          </ul>
        </div>
      </div>
      ...
      <div class="split-card">
        ...
        <div class="card-right-block flex-row-layout">
          ...
          <div class="time-badge">교육 시간 : 총 3시간</div>
        </div>
      </div>
      ...
      <div class="split-card">
        ...
        <div class="card-right-block">
          <ul class="body-list">
            <li>총 2명 (진행강사 1명, 보조강사 1명)</li>
            <li><span class="bullet-label">진행강사 :</span> 간호사(관련 자격 보유자) 또는 응급구조사(경력 5년 이상 종사자)</li>
            <li><span class="bullet-label">보조강사 :</span> 심폐소생술에 대한 전문지식을 갖춘 일반인 등</li>
          </ul>
        </div>
      </div>
      ...
      <div class="split-card double-layout-card">
        ...
        <div class="card-right-block flex-row no-padding overflow-hidden">
          ...
          <div class="card-img-side">
            <img src="https://cdn.imweb.me/upload/S20230801dc74a8f9b2b46/f7169ecfb7e96.png" alt="교직원 실습 교구" />
          </div>
        </div>
      </div>
...
<style>
  ...
  .apply-section {
    position: relative;
    padding: 90px 0;
    background-image: linear-gradient(rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0.75)), url('https://cdn.imweb.me/thumbnail/20230908/b213771e771ae.png');
